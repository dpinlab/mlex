...
import pandas as pd
import numpy as np
from mlex import RNN, DataReader, FeatureStratifiedSplit, F1MaxThresholdStrategy, StandardEvaluator, get_pcpe_dtype_dict, pcpe_preprocessing_read_func, ContextAware, PastFutureSplit
...
path_train = r'/data/pcpe/pcpe_03_train_I-d.csv'
path_test = r'/data/pcpe/pcpe_03_test_I-d.csv'
...
for sequence_composition in sequences_compositions:
    ...
    for sequence_length in sequence_lengths:
        ...
        for i in range(iterations):
            ...
            evaluator = StandardEvaluator(f"RNN_Layers-{num_layers}_HiddenSize-{hidden_size}_SequenceLength-{sequence_length}_{sequence_composition}_{threshold_strategy}_Iteration-{i+1}", threshold_selection)
