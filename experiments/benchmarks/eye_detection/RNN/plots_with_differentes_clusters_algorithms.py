...
curves = [
    {"sequence": "temporal", "cluster": "kmeans", "label": "temporal context"},
    {"sequence": "feature", "cluster": "kmeans", "label": "k-means context"},
    {"sequence": "feature", "cluster": "gmm", "label": "GMM context"},
    {"sequence": "feature", "cluster": "agglomerative", "label": "Agglomerative context"},
]
...
for length in lengths:
    ...
    fig, ax = plt.subplots()
    plotter.plot_roc_curve_with_ci(groups, ax=ax)
