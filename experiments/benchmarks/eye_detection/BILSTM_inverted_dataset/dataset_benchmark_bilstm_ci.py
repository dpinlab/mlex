...
for exp_name in experiment_names:
    if exp_name == 'temporal':
        train_path = f'{base_path}_inverted_temporal_train_inverted.csv'
        test_path = f'{base_path}_inverted_temporal_test_inverted.csv'
        sequence_composition = 'temporal'
    else:
        cluster_name = exp_name 
        train_path = f'{base_path}_inverted_{cluster_name}_train_inverted.csv'
        test_path = f'{base_path}_inverted_{cluster_name}_test_inverted.csv'
