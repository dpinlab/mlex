    ...
    for sequence_composition in sequences_compositions:
        ...
        for sequence_length in sequence_lengths:
            for i in range(iterations):
                ...
                evaluator = StandardEvaluator(f"GRU_Layers-{num_layers}_HiddenSize-{hidden_size}_SequenceLength-{sequence_length}_{sequence_composition}_{threshold_strategy}_Iteration-{i+1}_{cluster_name}", threshold_selection)
