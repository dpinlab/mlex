...
for sequence_composition in sequences_compositions:
    ...
    for sequence_length in sequence_lengths:
        ...
        for i in range(iterations):
            ...
            model = GRUModel(input_size=input_size, hidden_size=hidden_size, num_layers=num_layers, num_classes=num_classes)
            ...
            final_models.append(('GRU', sequence_composition, i+1, model.state_dict(), history, input_size, threshold_strategy, num_layers, sequence_length, batch_size, epochs, patience, optimizer.state_dict(), loss_fn.state_dict(), features_names_train))
...
df.to_parquet('results_GRU.parquet')
