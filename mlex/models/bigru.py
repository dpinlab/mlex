...
from mlex.models.base_components.bigru_base_model import BIGRUBaseModel
from mlex.utils.preprocessing import PreProcessingTransformer


class BIGRU(nn.Module, BaseEstimator, ClassifierMixin):
    ...
    def _build_model(self):
        ...
        self.final_model = BIGRUBaseModel(validation_data=model_params['validation_data'], **{k: v for k, v in model_params.items() if k != 'validation_data'})
