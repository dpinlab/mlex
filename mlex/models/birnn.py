...
from mlex.models.base_components.birnn_base_model import BIRNNBaseModel
from mlex.utils.preprocessing import PreProcessingTransformer


class BIRNN(nn.Module, BaseEstimator, ClassifierMixin):
    ...
    def _build_model(self):
        ...
        self.final_model = BIRNNBaseModel(validation_data=model_params['validation_data'], **{k: v for k, v in model_params.items() if k != 'validation_data'})
